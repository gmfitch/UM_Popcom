...
**f)** Explore these dynamics in Mathematica. Which parameters in this model correspond to the following terms in the Mathematica model: i) predator attack rate; ii) handling time; iii) conversion efficiency? What effect does an increase in each of these parameters have on the dynamics of the model?
