...
Try changing the value of $\lambda$. Note that when you change a parameter value, a line of code is printed to the console. It is possible to paste that exact line of code into the console to reproduce the same plot (i.e., you don't have to use Manupilate):
