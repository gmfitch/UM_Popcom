...
1. How could competitive exclusion lead to either phylogenetic over-dispersion or clustering?  How could environmental filtering lead to either phylogenetic over-dispersion or clustering?

2. What do "null community" phylogenetic studies assume? Describe, in a broad sense, how these studies are carried out.

3. How would one use patterns in phylogenetic clustering and evenness to distinguish between different processes of community assembly? How do the observed patterns in niche conservatism and phenotypic lability change the final interpretation?
